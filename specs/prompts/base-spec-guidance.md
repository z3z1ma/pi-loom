...
When the work is strategic, spans multiple specs, or needs a durable outcome container beyond a single bounded specification, inspect initiative memory before opening or extending a spec.
...
- inspect constitutional memory when durable project policy or roadmap commitments materially constrain the bounded specification
