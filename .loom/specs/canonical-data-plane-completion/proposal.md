...
## Overview
Complete Pi Loom's data-plane cutover after phase 1 by making events first-class, moving runtime-local launch state out of canonical entities, projecting the highest-value embedded subrecords into canonical artifact entities, and documenting the resulting adapter-facing contract.
