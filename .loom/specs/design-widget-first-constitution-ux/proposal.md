...
## Overview
Define the human-facing constitutional-memory experience around a persistent policy/roadmap widget, focused editing and review views, and a small set of human verbs for maintaining project vision, principles, constraints, and roadmap truth.
