...
## Overview
Define the human-facing documentation experience around a persistent docs widget, focused library/detail/revision views, and direct workflows for creating, updating, and reviewing documentation records without tool-mirroring commands.
