...
## Overview
Define the human-facing critique experience around a persistent review queue widget, focused packet/run/finding views, and direct workflows for launching, reviewing, and resolving critiques without tool-mirroring commands.
