...
## Overview
Define the human-facing plans experience around a persistent execution-strategy widget, focused milestone/progress and linked-ticket views, and direct workflows for managing workplan narratives without tool-mirroring commands.
