...
## Overview
Define the human-facing specification experience around a persistent change-overview widget, focused proposal/design/tasks views, and direct workflows for shaping and reviewing bounded change contracts without tool-mirroring commands.
