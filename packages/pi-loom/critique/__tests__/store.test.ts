  ...
  it("compiles fresh-context packets, records durable runs/findings, and creates follow-up tickets", async () => {
    ...
    const critique = await critiqueStore.createCritiqueAsync({
      ...
      target: {
        ...
        locator: "packages/pi-loom/critique/extensions/domain/store.ts",
      },
      ...
      scopeRefs: [
        "packages/pi-loom/critique/extensions/domain/store.ts",
        "packages/pi-loom/critique/extensions/tools/critique.ts",
      ],
