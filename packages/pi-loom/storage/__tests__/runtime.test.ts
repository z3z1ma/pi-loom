...
import { isRuntimeLeaseActive, renewRuntimeLease, SqliteRuntimeAttachmentStore } from "../runtime.js";
...
describe("sqlite runtime attachment store", () => {
  ...
  it("creates high-value composite indexes idempotently", async () => {
    ...
    try {
      const indexes = ["repositories", "worktrees", "entities", "runtime_attachments"].flatMap((table) =>
