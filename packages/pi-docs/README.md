...
- durable documentation records with canonical `state.json` and `revisions.jsonl` plus repo-materialized `packet.md` and `doc.md`; dashboard views are computed from canonical state instead of written as `dashboard.json`
