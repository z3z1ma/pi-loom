...
describe("chief prompt guidance", () => {
  it("includes chief doctrine and layer boundaries", () => {
    ...
    expect(guidance).toContain("Pi Chief is a thin orchestration layer on top of Pi Ralph.");
    ...
    expect(guidance).toContain("Ralph remains standalone and directly usable outside Pi Chief.");
