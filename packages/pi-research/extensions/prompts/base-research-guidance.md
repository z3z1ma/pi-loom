...
- treat research as the durable discovery/evidence layer, initiatives as strategic outcome containers, specs as declarative specifications of intended behavior, plans as the execution-strategy layer for staged multi-ticket work, tickets as the comprehensive execution ledger and self-contained units of work, critique as the adversarial review layer, and docs as the post-completion explanatory layer
