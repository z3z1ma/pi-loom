...
- upstream of a spec but not yet ready to formalize into a bounded change contract
...
- treat research as the durable discovery/evidence layer, initiatives as strategic outcome containers, specs as bounded change contracts, plans as the execution-strategy layer for staged multi-ticket work, tickets as the comprehensive execution ledger and self-contained units of work, critique as the adversarial review layer, and docs as the post-completion explanatory layer
