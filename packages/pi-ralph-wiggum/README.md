...
- iteration and runtime records are revisable checkpoints keyed by iteration id until the loop advances; they are durable observability, not an immutable append-only history API
