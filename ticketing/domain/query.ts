...
function ticketSearchText(record: TicketReadResult): string[] {
  return [
    ...
    record.ticket.frontmatter["branch-mode"],
    ...(record.ticket.frontmatter["branch-family"] ? [record.ticket.frontmatter["branch-family"]] : []),
    ...(record.ticket.frontmatter["exact-branch-name"] ? [record.ticket.frontmatter["exact-branch-name"]] : []),
